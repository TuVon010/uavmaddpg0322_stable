...
def get_config():
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.5e-4,
        help="critic learning rate (default: 1.5e-4)",
    )
    parser.add_argument(
        "--opti_eps",
        type=float,
    ...
    # ppo parameters
    parser.add_argument("--ppo_epoch", type=int, default=6, help="number of ppo epochs (default: 6)")
    parser.add_argument(
        "--use_clipped_value_loss",
        action="store_false",
        default=True,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.15,
        help="ppo clip parameter (default: 0.15)",
    )
    parser.add_argument(
        "--num_mini_batch",
        type=int,
    ...
    parser.add_argument(
        "--use_entropy_coef_decay",
        action="store_false",
        default=True,
        help="by default True, linearly decay entropy coefficient from start to end.",
    )
    parser.add_argument(
        "--entropy_coef_start",
        type=float,
        default=0.02,
        help="start value for entropy coefficient decay (default: 0.02).",
    )
    parser.add_argument(
        "--entropy_coef_end",
        type=float,
        default=0.003,
        help="end value for entropy coefficient decay (default: 0.003).",
    )
    parser.add_argument(
        "--use_clip_param_decay",
        action="store_false",
        default=True,
        help="by default True, linearly decay PPO clip parameter from start to end.",
    )
    parser.add_argument(
        "--clip_param_end",
        type=float,
        default=0.08,
        help="end value for PPO clip parameter decay (default: 0.08).",
    )
    parser.add_argument(
        "--value_loss_coef",
        type=float,
        default=0.8,
        help="value loss coefficient (default: 0.8)",
    )
    parser.add_argument(
        "--use_max_grad_norm",
        action="store_false",
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.3,
        help="max norm of gradients (default: 0.3)",
    )
    parser.add_argument(
        "--use_gae",
        action="store_false",
    ...
    parser.add_argument("--huber_delta", type=float, default=2.0, help=" coefficience of huber loss.")
